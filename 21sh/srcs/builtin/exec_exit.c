...
/*   Updated: 2018/05/06 17:28:33 by slegros          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (mode == 1)
		ft_putendl_col_fd("21sh: exit: Too many arguments", YEL, 2);
	else
		ft_putendl_col_fd("21sh: exit: Numeric arguments required", YEL, 2);
	return (1);
}
